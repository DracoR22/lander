        ...
        <div className="flex justify-center items-center z-10 flex-col relative">
            <Menu as="div">
                ...
                >
                    <Menu.Items
                        static
                        className="flex items-center justify-start flex-col absolute right-1/2 translate-x-1/2
                         mt-3 p-7 sm:min-w-[300px] min-w-max rounded-xl 
                        bg-white border border-nav-border shadow-menu"
